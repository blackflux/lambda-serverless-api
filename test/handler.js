...
module.exports.param = api.wrap('POST param', [
  ...
  api.FieldsParam('fieldsParam', 'json', { required: false, paths: 'id', autoPrune: false }),
  ...
  api.StrList('strListParam', 'query', { required: false }),
  api.FieldsParam('fieldsParam', 'query', { required: false, paths: 'id' }),
  ...
  api.Json('jsonParam', api.Joi.object().required(), 'json', { required: false }),
  api.Json('jsonParam', api.Joi.object().required(), 'query', { required: false }),
